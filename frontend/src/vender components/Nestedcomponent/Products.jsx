...
import { getvenderproduct } from "../../slices/venderSlice.js";
...
const Products = () => {
  ...
  console.log("this is a product array :" + products);
  return (  <>
                ...
                <div className="md:col-span-1">
                  <div className="p-4">
                    ...
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <button className="text-green-500  flex justify-center items-center text-2xl gap-2" onClick={()=>navigate("/vender-console/updateproduct",{state:{id:product._id,product:product}})}>
